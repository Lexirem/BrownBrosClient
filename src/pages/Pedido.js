            ...
            <div>
                <div className="carta-pedido">
                  <img className="logos" src="logo burgers.png" alt="logo burgers"/>
                    <div>
                      <h4>VEDELLA</h4>
                      <p>Vedella amb enciam, tomaquet, cogombres</p>
                      <p>Preu: 3,75€</p>
                    </div>
                    <div>
                      <h4>B.I.G PAPA</h4>
                    ...
                    <div>
                      <h4>POLLASTRE</h4>
                      <p>Crispy, amb enciam, tomaqut, cogombres</p>
                      <p>Preu: 3,75€</p>
                    </div>
                    <div>
                      <h4>B.I.G POLLO</h4>
                ...
                <div>
                  <img className="logos" src="logo butifarras.png" alt="logo butifarras"/>
                    <div>
                      ...
                      <p>Butifarra amb escalivada, enciam, salsa romesco i allioli de pollastre</p>
                      <p>Preu: 4,80€</p>
                    </div>
                    <div>
                      <h4>VATOS LOCOS</h4>
                      <p>Butifarra amb blat, enciam, salsa d'alvocat i llima, salsa jalapeño i cibulet</p>
                      <p>Preu: 4,80€</p>
                    </div>
                    <div>
                      <h4>SR. MIYAGI</h4>
                      <p>Butifarra amb bolets, enciam, salsa soja/wasabi i cibulet amb ceba crispy</p>
                      <p>Preu: 4,80€</p>
                    </div>
                    <div>
                      <h4>BROOKLIN ZOO</h4>
                      <p>Butifarra nature, enciam, ceba crispy, salsa BBQ Jack i crema de cacauet</p>
                      <p>Preu: 4,80€</p>
                    </div>
                  <hr></hr>
                </div>
                <div>
                  <img className="logos" src="logo bocatas.png" alt="logo bocatas"/>
                    ...
                    <div>
                      ...
                      <p>Croqueta de cigro amb llet de coco, soja i llima en pa de vidre, tomaquet</p>
                      <p>Preu: 4,80€</p>
                    </div>
                    <div>
